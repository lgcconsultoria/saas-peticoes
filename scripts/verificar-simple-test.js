...
const filePath = path.join(rootDir, 'templates', 'simple_test_output.docx');

// Caminho para salvar o XML extraído
const xmlOutputPath = path.join(rootDir, 'temp', 'simple_test_content.xml');
...
try {
  ...
  console.log('\n=== VERIFICANDO PALAVRAS-CHAVE DE TESTE ===\n');
  const palavrasChave = [
    'TESTE_COMPETENTE', 
    'TESTE_CIDADE', 
    'TESTE_MODALIDADE', 
